          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 sm:p-4 bg-[#F7F8FC] rounded-lg border">
                ...
                <span className="font-bold text-orange-600 text-sm sm:text-lg">${summary.totalJackpotContributions.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 sm:p-4 bg-[#F7F8FC] rounded-lg border">
                ...
                <span className="font-bold text-[#1F4E4A] text-sm sm:text-lg">${summary.totalWeeklyPayoutsDistributed.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 sm:p-4 bg-[#A1E96C]/10 rounded-lg border border-[#A1E96C]/30">
                ...
                <span className="font-bold text-[#1F4E4A] text-sm sm:text-lg">${summary.totalNetAvailableForFinalWinner.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 sm:p-4 bg-[#F7F8FC] rounded-lg border">
                ...
                <span className="font-bold text-blue-600 text-sm sm:text-lg">${summary.totalContributionsToNextGame.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 rounded-lg border">
                ...
                <span className="font-bold text-[#1F4E4A] text-sm sm:text-lg">${summary.organizationTotalPortion.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 rounded-lg border">
                ...
                <span className="font-bold text-purple-600 text-sm sm:text-lg">${summary.totalDonations.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 sm:p-4 bg-white/80 rounded-lg border">
                ...
                <span className="font-bold text-red-600 text-sm sm:text-lg">${summary.totalExpenses.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 sm:p-4 bg-[#A1E96C]/20 rounded-lg border-2 border-[#A1E96C]/50">
                ...
                <span className="font-bold text-[#1F4E4A] text-sm sm:text-xl">${summary.organizationNetProfit.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
            </div>
          </CardContent>
        </Card>
