  ...
  return (
    <div className="mt-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-2">
        ...
        <div className="text-center bg-green-50 border border-green-200 rounded-lg p-2 shadow-sm min-w-0">
          <p className="text-sm text-green-700 font-medium mb-1">Organization</p>
          <div className="flex gap-1">
            <div className="flex-1 min-w-0">
              <p className="text-xs text-gray-600">Current</p>
              <p className="text-sm font-semibold text-green-600 truncate">{formatCurrency(weekOrganizationTotal)}</p>
            </div>
            <div className="border-l border-green-200 pl-1 flex-1 min-w-0">
              <p className="text-xs text-gray-600">Cumulative</p>
              <p className="text-sm font-semibold text-green-700 truncate">{formatCurrency(cumulativeOrganizationNet)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center bg-purple-50 border border-purple-200 rounded-lg p-2 shadow-sm min-w-0">
          ...
          <div className="flex gap-1">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm font-semibold text-purple-600 truncate">{formatCurrency(displayedEndingJackpot)}</p>
            </div>
            <div className="border-l border-purple-200 pl-1 flex-1 min-w-0">
              <p className="text-xs text-gray-600">Cumulative</p>
              <p className="text-sm font-semibold text-purple-700 truncate">{formatCurrency(cumulativeCurrentJackpot)}</p>
            </div>
          </div>
        </div>
      </div>
