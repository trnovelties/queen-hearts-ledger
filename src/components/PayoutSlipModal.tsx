        ...
        <div ref={slipRef} className="bg-white p-8 space-y-8 print:p-4">
          ...
          <div className="text-center space-y-4 bg-green-50 border-2 border-green-300 rounded-lg p-8">
            ...
            <div className="text-6xl font-bold text-green-700">
              {formatCurrency(
                winnerData?.cardSelected === 'Queen of Hearts' && slipData?.game?.net_available_for_final_winner
                  ? slipData.game.net_available_for_final_winner
                  : (slipData.week?.weekly_payout || winnerData?.payoutAmount || 0)
              )}
            </div>
