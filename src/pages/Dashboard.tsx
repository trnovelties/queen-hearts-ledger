...
export default function Dashboard() {
  ...
  return <div className="space-y-6">
      ...
      <div className="flex space-x-1 bg-muted p-1 rounded-lg w-fit">
        ...
        <button onClick={() => setActiveTab('archived')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'archived' ? 'bg-white text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}>Queen of Hearts Hit. Please complete your Game 1 below last week tab.</button>
      </div>
