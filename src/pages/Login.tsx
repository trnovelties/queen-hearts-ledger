    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-2 sm:p-4 lg:p-2.5">
      ...
      <div className="w-full max-w-[85vw] sm:max-w-[80vw] lg:max-w-[1100px] h-auto lg:h-[680px] bg-gray-300 border-2 sm:border-[3px] border-black flex flex-col relative">
        ...
        <div className="h-auto lg:h-[220px] flex flex-col lg:flex-row border-b border-red-600">
          {/* Logo Section */}
          <div className="w-full lg:w-[280px] h-[130px] sm:h-[170px] lg:h-full flex items-center justify-center lg:justify-start px-4 sm:px-[35px] lg:px-4 lg:pr-[60px] py-4 lg:py-0">
          ...
          {/* Title Section */}
          <div className="flex-1 flex items-start justify-center lg:justify-end px-4 sm:px-6 lg:px-[50px] py-3 lg:py-[35px]">
            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-black text-right leading-tight">
          ...
          <div className="w-full lg:w-[540px] flex items-center justify-center px-2 sm:px-4 lg:px-[35px] lg:pr-[60px] py-4 lg:py-0">
            <div className="w-full max-w-[380px] sm:max-w-[460px] lg:w-[450px] bg-[#CC2136] shadow-[6px_10px_14px_rgba(0,0,0,0.35)] lg:shadow-[8px_12px_12px_rgba(0,0,0,0.45)] py-5">
              ...
              <div className="px-4 sm:px-6 lg:px-2.5 py-4 sm:py-6 lg:py-0">
                ...
                {/* Information Text */}
                <div className="text-white px-3 sm:px-4 lg:px-3 pt-4">
